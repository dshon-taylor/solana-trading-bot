 ...
 * diag_reporting.mjs
 *
 * Factory for the in-memory diagnostic snapshot machinery.
 * Provides refreshDiagSnapshot, getDiagSnapshotMessage, and maybeRefreshDiagSnapshot.
 *
 * Usage:
 *   const { refreshDiagSnapshot, getDiagSnapshotMessage, maybeRefreshDiagSnapshot }
 *     = createDiagReporting({ state, getCounters, cfg, birdseye, nowIso, fmtCt });
 */
...
export function createDiagReporting({
  ...
  function maybeRefreshDiagSnapshot(t) {
